...
Box::Box(glm::vec2 position, glm::vec2 velocity, float mass, glm::vec2 size, glm::vec4 colour)
	    : RigidBody(BOX, position, velocity, 0, mass)
{
	...
	m_localX = glm::vec2(1, 0);	//Local Axis X
	m_localY = glm::vec2(0, 1);	//Local Axis Y
}
